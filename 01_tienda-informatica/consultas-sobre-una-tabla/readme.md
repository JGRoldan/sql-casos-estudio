...
- [X] Lista el nombre de todos los productos que hay en la tabla producto.

- [X] Lista los nombres y los precios de todos los productos de la tabla producto.
...
- [X] Lista los nombres y los precios de todos los productos de la tabla producto, convirtiendo los nombres a minúscula.
...
- [X] Lista los nombres y los precios de todos los productos de la tabla producto, redondeando el valor del precio.
SELECT nombre, precio, ROUND(precio) as round_precio FROM producto;

- [X] Lista los nombres y los precios de todos los productos de la tabla producto, truncando el valor del precio para mostrarlo sin ninguna cifra decimal.

- [X] Lista el identificador de los fabricantes que tienen productos en la tabla producto.

- [X] Lista el identificador de los fabricantes que tienen productos en la tabla producto, eliminando los identificadores que aparecen repetidos.
...
- [X] Devuelve una lista con las 5 primeras filas de la tabla fabricante.

- [X] Devuelve una lista con 2 filas a partir de la cuarta fila de la tabla fabricante. La cuarta fila también se debe incluir en la respuesta.

- [X] Lista el nombre y el precio del producto más barato. (Utilice solamente las cláusulas ORDER BY y LIMIT)

- [X] Lista el nombre y el precio del producto más caro. (Utilice solamente las cláusulas ORDER BY y LIMIT)
